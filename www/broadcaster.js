...
module.exports = {
  ...
  //Paolo Labellarte 18-04-2016
  //Warkaround for issue about not exiting from app after attachaing event to broadcaster
  finishActivity: function () {
      exec(function () {

      }, function (err) {
          console.log("ERROR finishActivity: " + err)
      }, "broadcaster", "finishActivity", []);
